...
.PHONY: protoc
protoc:
	docker run -it --rm -v $(PWD)/../..:/work/github.com metalstack/builder bash -c "cd github.com/metal-stack/metal-api && protoc -I pkg/proto -I../../.. --go_out plugins=grpc:../../.. pkg/proto/v1/*.proto"
